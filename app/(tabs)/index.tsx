          ...
          <Animated.View style={{ opacity: headerAnim }}>
            <View style={styles.headerTop}>
              <View>
                ...
                <View style={styles.livePill}>
                  ...
                  <Text style={styles.liveText}>Live · Uttarakhand Command Center</Text>
                </View>
              </View>
            ...
            <View style={styles.healthCard}>
              <View style={styles.healthCardLeft}>
                ...
                <Text style={styles.healthCardSub}>Uttarakhand · {wards.length} Blocks Monitored</Text>
        ...
        <View style={styles.aqiCard}>
          <LinearGradient colors={["#7F1D1D", "#991B1B", "#B91C1C"]} style={styles.aqiGrad} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
            <View style={styles.aqiLeft}>
              ...
              <View>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                  <Text style={styles.aqiTitle}>Dehradun AQI</Text>
